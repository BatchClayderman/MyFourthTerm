...
HD_PWD='D:/Xilinx/Vivado/projects/vote/vote.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log biaojue.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source biaojue.tcl -notrace
