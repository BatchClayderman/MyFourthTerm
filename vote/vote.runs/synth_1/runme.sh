...
HD_PWD='D:/Xilinx/Vivado/projects/vote/vote.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log biaojue.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source biaojue.tcl
