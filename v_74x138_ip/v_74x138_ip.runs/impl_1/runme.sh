...
HD_PWD='C:/Users/Administrator/v_74x138_ip/v_74x138_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dsbjq.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dsbjq.tcl -notrace
