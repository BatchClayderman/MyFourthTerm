...
HD_PWD='D:/Xilinx/Vivado/projects/74x138/74x138.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_74X138.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_74X138.tcl -notrace
