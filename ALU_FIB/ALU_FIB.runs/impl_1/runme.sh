...
HD_PWD='D:/Xilinx/Vivado/projects/ALU_FIB/ALU_FIB.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log registers.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source registers.tcl -notrace
