...
HD_PWD='D:/Xilinx/Vivado/projects/x7seg/x7seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scroll_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source scroll_top.tcl
