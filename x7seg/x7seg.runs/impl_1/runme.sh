...
HD_PWD='D:/Xilinx/Vivado/projects/x7seg/x7seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log scroll_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source scroll_top.tcl -notrace
