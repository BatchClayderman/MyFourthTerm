...
HD_PWD='D:/Xilinx/Vivado/projects/shumaguan/shumaguan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shumaguan.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shumaguan.tcl
