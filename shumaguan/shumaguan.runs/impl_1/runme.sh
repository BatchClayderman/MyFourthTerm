...
HD_PWD='D:/Xilinx/Vivado/projects/shumaguan/shumaguan.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shumaguan.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shumaguan.tcl -notrace
